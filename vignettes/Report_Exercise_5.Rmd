...
```{r}
# The data is split in a 30/70 format
set.seed(1982)  # This is made for reproducibility
...
```{r}
# Model and pre-processing formulation, using all variables but LW_IN_F
