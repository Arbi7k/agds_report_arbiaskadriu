...
### Now same places with the same year are put together the column names are corrected
```{r}
...
## Task 3
### The three phases are made and seperated
```{r}
...
### The three phases are put together and a good looking table is made out of the data
```{r}
